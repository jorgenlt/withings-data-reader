  ...
  return (
    ...
    >
      <div className="page-container instructions">
        <h1>Instructions</h1>
        <p>Download your data from Withings and upload all of them here using the button in the navigation menu.</p>
        <p>No data is collected or uploaded to a server. All data is stored locally in your browser. Source code is available on <a href="https://github.com/jorgenlt/withings-data-reader" target="_blank" rel="noopener noreferrer">Github</a>.</p>
